...
## Project Structure
    ...
    ├── sparkling_limit_42283  # Django project configurations
...
1. Clone this repo and `cd sparkling_limit_42283`
...
2. Clone this repo and `cd sparkling_limit_42283`
