"""
Django settings for sparkling_limit_42283 project.
...
ROOT_URLCONF = 'sparkling_limit_42283.urls'
...
WSGI_APPLICATION = 'sparkling_limit_42283.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sparkling_limit_42283 API",
    "DESCRIPTION": "API documentation for sparkling_limit_42283 App",
    "VERSION": "v1",
}
